...
const shoppingCart1 = new ShoppingCard(user1.getId(), "66/110", false, "2025-1-15", "Not closed", user1.getState(), customer1.getId(), customer1.getAddress(), customer1.getPhone(), customer1.getEmail(), "2025-01-18", [lineItem1, lineItem2]);
console.log(shoppingCart1.toString());
const order1 = new Order(user1.getId(), "66/110", false, "2025-1-15", "Not closed", user1.getState(), customer1.getId(), customer1.getAddress(), customer1.getPhone(), customer1.getEmail(), "1", "2025-01-18", "2025-01-20", "NakornPhatom", 0, [lineItem1, lineItem2]);
console.log(order1.toString());
// สำหรับ User2
console.log("\n#################### Order & ShoppingCart (User2) ####################");
const shoppingCart2 = new ShoppingCard(user2.getId(), "Bangkok 02", false, "2025-1-16", "Not closed", user2.getState(), customer2.getId(), customer2.getAddress(), customer2.getPhone(), customer2.getEmail(), "2025-01-19", [lineItem3, lineItem4, lineItem5]);
console.log(shoppingCart2.toString());
const order2 = new Order(user2.getId(), "Bangkok 02", false, "2025-1-16", "Not closed", user2.getState(), customer2.getId(), customer2.getAddress(), customer2.getPhone(), customer2.getEmail(), "2", "2025-01-19", "2025-01-21", "Bangkok", 0, [lineItem3, lineItem4, lineItem5]);
